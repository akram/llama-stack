...
class OAuth2TokenAuthProvider(AuthProvider):
    ...
    async def introspect_token(self, token: str, scope: dict | None = None) -> User:
        ...
        try:
            ...
            logger.warning(f"Error during token introspection: {str(e)}")
        ...
        try:
            async with httpx.AsyncClient() as client:
                ...
                try:
                    ...
                    logger.warning(f"Error parsing authentication response: {str(e)}")
            ...
            logger.warning(f"Error during authentication: {str(e)}")
